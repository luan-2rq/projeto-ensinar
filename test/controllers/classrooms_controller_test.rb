...
class ClassroomsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create classroom" do
    assert_difference("Classroom.count") do
      post classrooms_url, params: { classroom: { code: @classroom.code, enabled: @classroom.enabled, name: @classroom.name, professor_id: @classroom.professor_id } }
    end
  ...
  test "should update classroom" do
    patch classroom_url(@classroom), params: { classroom: { code: @classroom.code, enabled: @classroom.enabled, name: @classroom.name, professor_id: @classroom.professor_id } }
