Rails.application.routes.draw do
  ...
  post 'exam/answer-question', to: 'exams#answer_question'
  get 'exam/close-question', to: 'exams#show_close_question'
  get 'exam/open-question', to: 'exams#show_open_question'
